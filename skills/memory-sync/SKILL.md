---
name: memory-sync
description: Git synchronization operations for pi-memory repository. Use when you need to sync memory.
---

# Memory Sync

Git synchronization for pi-memory repository.

## Configuration

Configure `pi-memory.repoUrl` in settings file (global: `~/.pi/agent/settings.json`, project: `.pi/settings.json`)
